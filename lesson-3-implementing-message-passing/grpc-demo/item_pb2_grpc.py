...
class ItemServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                '/ItemService/Create',
                request_serializer=item__pb2.ItemMessage.SerializeToString,
                response_deserializer=item__pb2.ItemMessage.FromString,
...
def add_ItemServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=item__pb2.ItemMessage.FromString,
                    response_serializer=item__pb2.ItemMessage.SerializeToString,
            ),
    }
...
class ItemService(object):
    ...
    def Create(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ItemService/Create',
            item__pb2.ItemMessage.SerializeToString,
            item__pb2.ItemMessage.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
